...
return packer.startup(function(use)
  ...
  -- Packer itself
  use({ "git@github.com:wbthomason/packer.nvim.git", run = ":MasonUpdate", opt = true }) -- We can specify a specific commit by commit="commit_id"
  ...
  use({ "git@github.com:nvim-treesitter/nvim-treesitter-context.git" })           -- Code context on the top like fn name
  use({ "git@github.com:nvim-treesitter/playground.git" })                        -- Code highlight
  ...
  use({ "git@github.com:hrsh7th/cmp-nvim-lsp-signature-help.git" }) -- LSP completion fn signature
  ...
  -- Color highlight  NvChad /
  use({ "git@github.com:NvChad/nvim-colorizer.lua.git" })         -- fast color highlight (show the color like this #FFFFFF)
  use({ "git@github.com:roobert/tailwindcss-colorizer-cmp.nvim" }) -- cmp-colors
  ...
  use({ "git@github.com:nvim-lua/plenary.nvim.git" })                      --background jobs runner
